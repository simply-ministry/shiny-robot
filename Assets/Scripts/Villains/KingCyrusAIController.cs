...
// Manages the AI and abilities for the antagonist King Cyrus.
public class KingCyrusAIController : MonoBehaviour
{
...
{
Debug.Log($"King Cyrus uses a signature attack on {target.name}!");
}
