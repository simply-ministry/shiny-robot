...
// Manages the AI and abilities for the antagonist Lucent.
public class LucentAIController : MonoBehaviour
{
...
{
Debug.Log($"Lucent uses a signature attack on {target.name}!");
}
