...
// Manages the AI and abilities for the antagonist Delilah.
public class DelilahAIController : MonoBehaviour
{
...
{
Debug.Log($"Delilah uses a signature attack on {target.name}!");
}
